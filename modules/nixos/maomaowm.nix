...
# hardware keys: brightness and volume
...
# menu and terminal (matching Niri)
...
# switch window focus (VIM-LIKE - matching Niri)
...
bind=SUPER+SHIFT,2,toggletag,2
bind=SUPER+SHIFT,3,toggletag,3
bind=SUPER+SHIFT,4,toggletag,4
bind=SUPER+SHIFT,5,toggletag,5
bind=SUPER+SHIFT,6,toggletag,6
bind=SUPER+SHIFT,7,toggletag,7
bind=SUPER+SHIFT,8,toggletag,8
bind=SUPER+SHIFT,9,toggletag,9


# swap window (VIM-LIKE - matching Niri Ctrl)
...
# tag switch (matching Niri - Super + numbers)
...
# MONITOR RULES
# Laptop internal display – explicit native mode and scale
monitorrule=eDP-1,0.33,1,scroller,0,1.75,0,0,3200,2000,120
monitorrule=DP-3,0.33,1,scroller,0,1,0,0,3440,1440,180
tile
# monitor switch (matching Niri Shift)
...
layerrule=animation_type_close:zoom,layer_name:rofi
        '';
        autostart_sh = ''
          # Start Ignis 3 (same as Niri's spawn-at-startup)
          ignis init -c /home/drizzy/NEWFLAKE/modules/no-nix/ignis3/config.py &
        '';
      };
    }
  ];
